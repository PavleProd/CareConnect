...
@Component({
  selector: 'app-manager-change-patient',
  templateUrl: './manager-change-patient.component.html',
  styleUrls: ['./manager-change-patient.component.css']
})
export class ManagerChangePatientComponent implements OnInit {

  constructor(private userService: UserService, private router: Router, private fileService: FileService) { }

  ngOnInit(): void {
    this.user = JSON.parse(sessionStorage.getItem('patient'))
  }
